...
class User extends Migrator
{
    ...
    public function change()
    {
        ...
        $table->addColumn('username', 'string',array('limit' => 15,'default'=>'','comment'=>'用户名，登陆使用'))
            ...
            ->addColumn('groupid', 'tinyint',array('limit' => 4,'default'=>2,'comment'=>'登陆状态'))
            ...
            ->addColumn('reg_time', 'integer',array('limit' => 11,'default'=>'','comment'=>'注册时间'))
            ->addColumn('last_login_time','integer',array('limit'=>11,'comment'=>"最后登录时间"))
            ->addColumn('uid','integer',array('limit'=>11,'comment'=>"最后登录时间"))
            ->addIndex(array('uid'), array('primary' => true))
            ->create();
    }
}
